...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="container-fluid py-4">
    <div class="row">
      <div class="col-12">
        <a href="create" class="btn btn-primary">Register User</a>
              ...
              <?php foreach ($users as $user) { ?>
                <tr>
                  ...
                  <td class="align-middle">
                    <a href="edit/<?php echo $user->id ?>" class="btn btn-secondary" data-toggle="tooltip" data-original-title="Edit user">
                      Edit
                    </a>

                    <a href="javascript:;" class="btn btm-danger" data-toggle="tooltip" data-original-title="Edit user">
                      Delete
                    </a>
                  </td>
                </tr>
